/**
 * Dependency-free canonical JSON and SHA-256 primitives shared by persisted
 * contract producers and consumers.
 *
 * The implementation is synchronous so browser-safe runtime code can verify
 * content-addressed records before constructing executable adapters.
 */
