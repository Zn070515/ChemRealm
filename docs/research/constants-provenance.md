...
|---|---:|---|---|---|---|
| `Kw` | `1.0000e-14` | thermodynamic autoprotolysis constant of water | activity/molality convention, 25 °C | [IUPAC Gold Book, autoprotolysis constant](https://goldbook.iupac.org/terms/view/A00532); source states `1.0 × 10⁻¹⁴` at 25 °C | pinned at source precision |
