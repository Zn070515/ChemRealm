...
must(plan, /\*\*Status:\*\* \*\*M0–M4 S3 Verified \/ Accepted; M5 (?:authorized|S2 (?:remediation|production composition) in progress)\*\*/i, "PLAN records M5 authorization/remediation after M4 S3");
